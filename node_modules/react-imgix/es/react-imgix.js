...
function buildSrc(_ref) {
  ...
  if (disableSrcSet) {
    ...
    if (fixedSize) {
      ...
      var constructedUrl = constructUrl(rawSrc, urlParams);
      ...
      srcSet = "";
      var len = DPR_QUALITY_VALUES.length;

      for (var i = 0; i < len; i++) {
        var quality = DPR_QUALITY_VALUES[i];
      ...
      srcSet = "";
      var _len = targetWidths.length;

      for (var _i2 = 0; _i2 < _len; _i2++) {
        var targetWidth = targetWidths[_i2];
...
var ReactImgixWrapped = compose(ShouldComponentUpdateHOC)(ReactImgix);
